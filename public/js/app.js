...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // import * as home from "./pages/home";
// import nav from "./components/nav";


var MY_SITE = {
  // you have one namespace-object where you hold all your stuff
  components: ["nav", "map", "smoothScroll"],
...
var map = {
	...
	"./mapData": "./resources/js/components/mapData.json",
	"./mapData.json": "./resources/js/components/mapData.json",
	...
	"./smoothScroll": "./resources/js/components/smoothScroll.js",
	"./smoothScroll.js": "./resources/js/components/smoothScroll.js"
};
...
var mapData = __webpack_require__(/*! ./mapData.json */ "./resources/js/components/mapData.json");
...
function initMap() {
  ...
  Object.keys(mapData).forEach(function (key) {
    Object.values(mapData[key]).forEach(function (element, i) {
...
function drop() {
  clearMarkers();
  myData.forEach(function (element) {}); // for (let i = 0; i < neighborhoods.length; i++) {
...
/***/ "./resources/js/components/mapData.json":
/*!**********************************************!*\
  !*** ./resources/js/components/mapData.json ***!
  \**********************************************/
/*! exports provided: school, recreation, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"school\":[{\"lat\":52.511,\"lng\":13.447},{\"lat\":49.210233000000024,\"lng\":-123.13681400000002},{\"lat\":49.174657999999994,\"lng\":-123.127408},{\"lat\":49.260605200000015,\"lng\":-123.24599380000001}],\"recreation\":[{\"lat\":52.511,\"lng\":13.447},{\"lat\":52.549,\"lng\":13.422},{\"lat\":52.497,\"lng\":13.396},{\"lat\":52.517,\"lng\":13.394}]}");
...
/***/ "./resources/js/components/smoothScroll.js":
/*!*************************************************!*\
  !*** ./resources/js/components/smoothScroll.js ***!
  \*************************************************/
/*! no static exports found */
...
var backendFn = function backendFn(params) {
  axios.post("/registrants/new", params).then(function (response) {
...
__webpack_require__(/*! C:\xampp\htdocs\irix-template\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\irix-template\resources\sass\app.scss */"./resources/sass/app.scss");
